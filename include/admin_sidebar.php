...
$navGroups = [
    ...
    'Ordering & Tables' => [
        ['orders.php', 'fa-solid fa-receipt', 'Orders'],
        ['tables.php', 'fa-solid fa-qrcode', 'Tables & QR'],
    ],
    'Staff Management' => [
        ['attendance.php', 'fa-solid fa-fingerprint', 'Attendance / DTR'],
        ['cleaning.php', 'fa-solid fa-broom', 'Cleaning Assignments'],
        ['staff.php', 'fa-solid fa-users', 'Staff'],
    ],
    'Store & Inventory' => [
        ['menu.php', 'fa-solid fa-book-open', 'Menu Items'],
        ['inventory.php', 'fa-solid fa-boxes-stacked', 'Inventory'],
        ['receipts.php', 'fa-solid fa-file-invoice', 'Receipts'],
    ],
    'Customer Engagement' => [
        ['feedback.php', 'fa-solid fa-comment-dots', 'Feedback'],
        ['chatbot.php', 'fa-solid fa-robot', 'Chatbot Logs'],
    ],
    'Reports' => [
        ['reports.php', 'fa-solid fa-chart-line', 'Reports & Analytics'],
    ],
];
?>
    ...
    <div class="offcanvas-header border-bottom" style="border-color: var(--sb-border) !important; padding: 16px 20px;">
        <div class="d-flex align-items-center gap-2" id="sidebarDrawerLabel">
            ...
            <div class="brand-text lh-sm">
                ...
                <span class="text-secondary" style="font-size:10.5px;">Admin Panel</span>
            </div>
        </div>
